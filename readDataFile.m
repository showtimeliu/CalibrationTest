...
%READDATAFILE Read the data from the .dat files 
%   Input: 
%       strFile - directory of the data file 
%       cellArray - the array of header information from readHeader 
%   
%   Output: 
%       pdIMAQ - IMAQ spectra of a frame recorded, for PS OCT data, the
%       dimension is LineLength, NumberOfLines, CameraIndex
%       pdDAQ  - DAQ waveforms 
